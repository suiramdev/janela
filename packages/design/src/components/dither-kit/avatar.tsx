...
function avatarModel(
  ...
  for (let r = 0; r < GRID; r++) {
    for (let c = 0; c < GRID; c++) {
      ...
      // `i` is in range by construction — both branches max out at 31 for a
      // 32-entry half — but `noUncheckedIndexedAccess` cannot see that, and this
      // repository does not permit `!` (AGENTS.md § Conventions).

...
function SidebarProvider({
  ...
  React.useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      // `⌘B` only. The registry copy also accepts `Ctrl-B`, and this application may
      // not: `Ctrl` belongs to whatever is running inside a terminal, and `Ctrl-B` in
      // particular is tmux's default prefix (AGENTS.md § Non-negotiables 4).

...
import type { ItemRect, UseFluidHoverReturn } from "../../hooks/use-fluid-hover.ts";
...
export type FluidHoverHighlightProps = (HighlightFromHook | HighlightFromRect) & {
  ...
  // Explicit `| undefined`: `exactOptionalPropertyTypes`, and the sidebar's
  // menu scope forwards this whether or not it resolved a value.

...
import { DEFAULT_GLOBAL_SETTINGS, withSilencedConfirmation } from "../../../shared/model/index.ts";
import {
  SERVICE_CONFIRM_TITLE,
  SERVICE_REQUEST_TITLE,
  serviceStopCost,
} from "../model/background-service.ts";
import { ServiceCostConfirmation, SettingsGeneral } from "./general-settings.tsx";
